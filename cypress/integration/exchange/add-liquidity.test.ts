describe('Add Liquidity', () => {
  ...
  it('loads the WBNB and tokens', () => {
    cy.visit('/add/0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82')
  ...
  it('redirects /add/WBNB to /add/WBNB/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82',
    )
  })

  it('redirects /add/token-WBNB to /add/token/WBNB', () => {
    cy.visit('/add/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82-0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720')
    cy.url().should(
      'contain',
      '/add/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82/0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720',
    )
  })
})
