...
const RoiCalculatorFooter: React.FC<RoiCalculatorFooterProps> = ({
  ...
  const {
    ...
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of AGS rewards each farm receives, as a proportion of the AGS produced each block.',
        )}
      </Text>
      <Text my="24px">
        {t('For example, if a 1x farm received 1 AGS per block, a 40x farm would receive 40 AGS per block.')}
      </Text>
